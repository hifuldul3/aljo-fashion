...
import { Lock, Mail, ArrowRight, ShieldCheck, Sparkles, UserCheck, Smartphone } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto px-4 py-16 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-neutral-400">
          Once created, sign in using your registered email or phone on any device (Mobile, Tablet, PC).
        </p>
      </div>
      ...
      <form onSubmit={handleLogin} className="glass-card rounded-3xl p-6 sm:p-8 space-y-4 border border-neutral-800">
        ...
        <div>
          <label className="text-xs font-semibold text-neutral-300 block mb-1">Email Address or Phone Number</label>
          <div className="relative">
            ...
            <input
              ...
              placeholder="e.g. user@aljo.com or +91 98765 43210"
        ...
        <div className="text-center pt-2 text-xs text-neutral-400 space-y-1">
          <p>Don't have an account yet?</p>
          <Link href="/register" className="inline-block text-amber-300 font-bold hover:underline">
